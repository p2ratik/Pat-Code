...
import { Loader2, MoreHorizontal, Plus, Shield, X } from "lucide-react";
          ...
          <tbody className="divide-y divide-zinc-800">
            ...
            {isError && (
              <tr>
                <td
                  colSpan={5}
                  className="px-6 py-10 text-center text-red-400 text-xs"
                >
                  ...
                  {user.roles.length > 0 ? (
                    <div className="flex flex-wrap gap-1">
                      {user.roles.map((r) => (
                        <span
                          key={r}
                          className="flex items-center gap-1 text-xs px-2 py-0.5 rounded bg-zinc-800 text-zinc-300 border border-zinc-700"
                        >
                          {r.includes("admin") && (
